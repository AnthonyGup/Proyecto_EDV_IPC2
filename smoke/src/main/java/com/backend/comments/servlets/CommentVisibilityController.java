...
public class CommentVisibilityController extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CommentVisibilityController.class.getName()).log(Level.SEVERE, "Error SQL al actualizar visibilidad de comentarios", ex);
